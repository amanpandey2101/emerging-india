...
export default function Heritageslider() { 
  ...
  <div class="rounded-lg shadow-lg bg-white max-w-sm">
    <a href="https://whc.unesco.org/en/list/232/" target={"_blank"} data-mdb-ripple="true" data-mdb-ripple-color="light" rel="noreferrer">
      <img class="rounded-t-lg sm:h-72" src={require("../assets/images/humayu.avif")} alt=""/>
    </a>
    <div class="p-6">
  ...
  <div class="rounded-lg shadow-lg bg-white max-w-sm">
    ...
    <div class="p-6">
      ...
      <p class="text-gray-700 text-base mb-4">
      Fatehpur Sikri is a town in the Agra District of Uttar Pradesh, India. Situated 35.7 kilometres from the district headquarters of Agra,Fatehpur Sikri itself was founded as the capital of Mughal Empire in 1571 by Emperor Akbar...
      </p>
      <button type="button" class=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Read More</button>
    </div>
  </div>
  ...
  <div class="rounded-lg shadow-lg bg-white max-w-sm">
    ...
    <div class="p-6">
      ...
      <p class="text-gray-700 text-base mb-4">
      The Jantar Mantar, in Jaipur, is an astronomical observation site built in the early 18th century. It includes a set of some 20 main fixed instruments. They are monumental examples in masonry of known...
      </p>
